...
export const UserDeleteConfirmationModal: React.FC<UserDeleteConfirmationModalProps> = ({ user, onConfirm, onCancel }) => {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-60 flex justify-center items-center z-50 animate-fade-in-up">
      <div className="bg-white rounded-xl shadow-2xl p-8 w-full max-w-md relative">
        ...
        <p className="text-gray-700 mb-4">
          {t('confirmDeleteUserMsg')} <strong className="font-semibold">{user.id}</strong>?
        </p>
